...
public class RawAuthClient {
     ...
     */
    public AuthItClientHttpResponse<GetTokenResponse> getToken(AuthGetTokenRequest request) {
     ...
     * Obtain an OAuth2 access token using client credentials
     */
    public AuthItClientHttpResponse<GetTokenResponse> getToken(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new AuthItClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), GetTokenResponse.class), response);
            }
