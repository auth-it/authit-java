...
public class AuthItClientBuilder {
     ...
     */
    public AuthItClientBuilder clientId(String clientId) {
     ...
     */
    public AuthItClientBuilder clientSecret(String clientSecret) {
        this.clientSecret = clientSecret;
        return this;
    }

    public AuthItClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AuthItClientBuilder url(String url) {
     ...
     */
    public AuthItClientBuilder timeout(int timeout) {
     ...
     */
    public AuthItClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AuthItClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AuthItClientBuilder addHeader(String name, String value) {
        this.customHeaders.put(name, value);
        return this;
    }

    public AuthItClientBuilder realm(String realm) {
        this.realm = realm;
        return this;
    }
    ...
    public AuthItClient build() {
        validateConfiguration();
        return new AuthItClient(buildClientOptions());
    }
}
