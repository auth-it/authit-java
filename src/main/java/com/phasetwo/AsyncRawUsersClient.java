...
public class AsyncRawUsersClient {
     ...
     */
    public CompletableFuture<PhasetwoClientHttpResponse<UpConfig>> getAdminRealmsRealmUsersProfile(String realm) {
     ...
     * Get the configuration for the user profile
     */
    public CompletableFuture<PhasetwoClientHttpResponse<UpConfig>> getAdminRealmsRealmUsersProfile(
        ...
        CompletableFuture<PhasetwoClientHttpResponse<UpConfig>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<PhasetwoClientHttpResponse<UpConfig>> putAdminRealmsRealmUsersProfile(String realm) {
     ...
     * Set the configuration for the user profile
     */
    public CompletableFuture<PhasetwoClientHttpResponse<UpConfig>> putAdminRealmsRealmUsersProfile(
            String realm, UpConfig request) {
     ...
     */
    public CompletableFuture<PhasetwoClientHttpResponse<UserProfileMetadata>> getAdminRealmsRealmUsersProfileMetadata(
            String realm) {
    ...
    public CompletableFuture<PhasetwoClientHttpResponse<UserProfileMetadata>> getAdminRealmsRealmUsersProfileMetadata(
        ...
        CompletableFuture<PhasetwoClientHttpResponse<UserProfileMetadata>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<PhasetwoClientHttpResponse<List<String>>>
    ...
    public CompletableFuture<PhasetwoClientHttpResponse<List<String>>>
        ...
        CompletableFuture<PhasetwoClientHttpResponse<List<String>>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<PhasetwoClientHttpResponse<List<CredentialRepresentation>>>
            getAdminRealmsRealmUsersUserIdCredentials(String realm, String userId) {
        return getAdminRealmsRealmUsersUserIdCredentials(realm, userId, null);
    }

    public CompletableFuture<PhasetwoClientHttpResponse<List<CredentialRepresentation>>>
            getAdminRealmsRealmUsersUserIdCredentials(String realm, String userId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("admin/realms")
                .addPathSegment(realm)
        ...
        CompletableFuture<PhasetwoClientHttpResponse<List<CredentialRepresentation>>> future =
    ...
    public CompletableFuture<PhasetwoClientHttpResponse<Void>> removeACredentialForAUser(
    ...
    public CompletableFuture<PhasetwoClientHttpResponse<Void>> updateACredentialLabelForAUser(
            String realm, String userId, String credentialId) {
    ...
    public CompletableFuture<PhasetwoClientHttpResponse<Void>> disableAllCredentialsForAUserOfASpecificType(
    ...
    public CompletableFuture<PhasetwoClientHttpResponse<List<FederatedIdentityRepresentation>>>
            getSocialLoginsAssociatedWithTheUser(String realm, String userId) {
        return getSocialLoginsAssociatedWithTheUser(realm, userId, null);
    }

    public CompletableFuture<PhasetwoClientHttpResponse<List<FederatedIdentityRepresentation>>>
            getSocialLoginsAssociatedWithTheUser(String realm, String userId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("admin/realms")
                .addPathSegment(realm)
        ...
        CompletableFuture<PhasetwoClientHttpResponse<List<FederatedIdentityRepresentation>>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new PhasetwoClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(),
                                        new TypeReference<List<FederatedIdentityRepresentation>>() {}),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
    ...
    public CompletableFuture<PhasetwoClientHttpResponse<Void>> addASocialLoginProviderToTheUser(
    ...
    public CompletableFuture<PhasetwoClientHttpResponse<Void>> removeASocialLoginProviderFromUser(
            String realm, String userId, String provider) {
    ...
    public CompletableFuture<PhasetwoClientHttpResponse<List<UserSessionRepresentation>>>
            getOfflineSessionsAssociatedWithTheUserAndClient(String realm, String userId, String clientUuid) {
        return getOfflineSessionsAssociatedWithTheUserAndClient(realm, userId, clientUuid, null);
    }

    public CompletableFuture<PhasetwoClientHttpResponse<List<UserSessionRepresentation>>>
            getOfflineSessionsAssociatedWithTheUserAndClient(
    ...
    public CompletableFuture<PhasetwoClientHttpResponse<Void>> setUpANewPasswordForTheUser(
            String realm, String userId) {
     ...
     */
    public CompletableFuture<PhasetwoClientHttpResponse<Void>>
            sendAnEmailToTheUserWithALinkTheyCanClickToResetTheirPassword(String realm, String userId) {
     ...
     */
    public CompletableFuture<PhasetwoClientHttpResponse<Void>>
            sendAnEmailToTheUserWithALinkTheyCanClickToResetTheirPassword(
    ...
    public CompletableFuture<PhasetwoClientHttpResponse<Map<String, List<String>>>>
            getAdminRealmsRealmUsersUserIdUnmanagedAttributes(String realm, String userId) {
     ...
     */
    public CompletableFuture<PhasetwoClientHttpResponse<Void>> switchActiveOrganization(
     ...
     */
    public CompletableFuture<PhasetwoClientHttpResponse<ActiveOrganizationRepresentation>> getActiveOrganization(
            String realm) {
    ...
    public CompletableFuture<PhasetwoClientHttpResponse<ActiveOrganizationRepresentation>> getActiveOrganization(
        ...
        CompletableFuture<PhasetwoClientHttpResponse<ActiveOrganizationRepresentation>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
