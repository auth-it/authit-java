...
public class AsyncRawRealmsAdminClient {
    protected final ClientOptions clientOptions;

    public AsyncRawRealmsAdminClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<PhasetwoClientHttpResponse<Void>> putAdminRealmsRealmEventsConfig(String realm) {
     ...
     * Update the events provider Change the events provider and/or its configuration
     */
    public CompletableFuture<PhasetwoClientHttpResponse<Void>> putAdminRealmsRealmEventsConfig(
